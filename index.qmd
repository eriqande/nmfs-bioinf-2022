...
* Day 1: Intro, Unix-review, shell programming, `awk`
    ...
    - [A Brief `awk` Intro](awk-intro.qmd#awk-intro)  Processing text files with `awk` (30 minutes)
* Day 2: A little bash stuff, then Sedna and SLURM
    - [Bash scripts and functions](scripts-and-functions.qmd#script-func) (20 minutes)
    - [Sedna and SLURM intro](slurm.qmd#ssintro) (40 minutes) 
    - [Submitting jobs with `sbatch`](sbatch.qmd#sbatch) (40 minutes)
    - [Slurm Job Arrays](slurm-arrays.qmd#slurm-arrays) (40 minutes)
* Day 3: Job Arrays, then an introduction to Snakemake
    - [Slurm Job Arrays](slurm-arrays.qmd#slurm-arrays) (25 minutes)
    - Snakemake. Will somewhat follow [these slides](https://eriqande.github.io/con-gen-2022/slides/snake-slides.html#/section)
