...
* Day 2: A little bash stuff, then Sedna and SLURM
    - [Shell scripts and bash functions](scripts-and-functions.qmd#script-func) (20 minutes)
    - [Computing clusters, Sedna, SLURM, and modules](slurm.qmd#ssintro) (40 minutes) sessions,
