...
Conservation Genomics Workshop, Friday September 9, 2022
:::
...
* Pretty easy integration (once you get past the somewhat scattered documentation)
with SLURM on your cluster.  (I recommend checking out the resources at
...
The way to most easily allows Snakemake to dispatch jobs via the SLURM
...
partial to the Unix-based (as opposed to Python-based) approach to a SLURM
...
1. Get an interactive shell on a compute node with 2 cores.  Check it out for three or four
